...
def bids():
	...
	L_positionsR=Label(top,text="Possitions required: ")
	L_positionsR.grid(row=3,column=0,sticky="E")
	E_positionsR=Entry(top)
	E_positionsR.grid(row=3,column=1,sticky="W")

	B_validate=Button(top,text="make bid",command=make_bid)
	B_validate.grid(row=4,column=0,sticky="E")
...
publicc=Button(root,text="Public a ride",padx=15,pady=10,command=button1)
